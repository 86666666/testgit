...
// import axios from "/antdb/node_modules/axios/index.js";
...
//前端判断登录状态函数
//配置请求的基础url
axios.defaults.baseURL = 'http://121.37.152.111:8000';
function denglu(){
    ...
    if(username=='admin' && password==2567){
        ...
        axios.post('cbv/login/',{username:username,assword:password}).then(
